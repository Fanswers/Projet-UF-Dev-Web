...
if($_POST)
{
    executeRequete("INSERT INTO logement (logement_type, total_occupant, total_chambre, total_toilette, adresse, departement, tv, kitchen, climatisation, chauffage, internet, prix, proprietaire_id) VALUES ('$_POST[logement_type]', '$_POST[total_occupant]', '$_POST[total_chambre]', '$_POST[total_toilette]', '$_POST[adresse]', '$_POST[departement]', '$_POST[tv]', '$_POST[kitchen]', '$_POST[climatisation]', '$_POST[chauffage]', '$_POST[internet]', '$_POST[prix]', '$id_user')");
